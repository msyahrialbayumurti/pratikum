...
public class DataMahasiswa {
    ...
    public static int interpolationSearch(ArrayList<Mahasiswa> list, String nimTarget) {
        int low = 0;
        int high = list.size() - 1;
        while (low <= high && nimTarget.compareTo(list.get(low).getNim()) >= 0
                && nimTarget.compareTo(list.get(high).getNim()) <= 0) {
    ...
    public static void main(String[] args) {
        ...
        while (continueInput) {
            ...
            switch (choice) {
                ...
                case 3:
                    // Menerima indeks dari pengguna dan menghapus data mahasiswa pada indeks
                    // tersebut
