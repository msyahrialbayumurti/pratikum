...
public class Stephash {
    ...
    public void insert(int value) {
        ...
        while (table[index] != 0) {
            System.out.println("Terjadi kolisi pada key: " + index);
            index = (index + step) % table.length; // Gunakan langkah untuk mencari slot kosong
            System.out.println("Indeks digeser ke: " + index);
        }
        table[index] = value; // Sisipkan nilai
        System.out.println("Data dimasukkan ke dalam indeks: " + index);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hasil pencarian nilai 8 di Index: " + stepHash.search(8)); // Harusnya mengembalikan -1

        // Mencari nilai yang tidak ada
        System.out.println("Hasil pencarian nilai 200 di Index: " + stepHash.search(200)); // Harusnya mengembalikan -1
    }
}
